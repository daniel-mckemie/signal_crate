...
static const float hilbert_taps[HILBERT_LEN] = {
    ...
    0.0f,     -0.0062f, 0.0f,     -0.0070f, 0.0f,     -0.0081f, 0.0f,
    -0.0096f, 0.0f,     -0.0117f, 0.0f,     -0.0148f, 0.0f,     -0.0193f,
    0.0f,     -0.0260f, 0.0f,     -0.0366f, 0.0f,     -0.0553f, 0.0f,
    -0.0967f, 0.0f,     -0.3183f, 0.0f,     0.3183f,  0.0f,     0.0967f,
    0.0f,     0.0553f,  0.0f,     0.0366f,  0.0f,     0.0260f,  0.0f,
    0.0193f,  0.0f,     0.0148f,  0.0f,     0.0117f,  0.0f,     0.0096f,
    0.0f,     0.0081f,  0.0f,     0.0070f,  0.0f,     0.0062f,  0.0f};
...
static void fm_mod_process(Module *m, float *in, unsigned long frames) {
    ...
    for (unsigned long i = 0; i < frames; i++) {
        ...
        float real =
            state->hilbert_delay[(state->hilbert_pos + HILBERT_LEN / 2) %
                                 HILBERT_LEN];
...
static void fm_mod_draw_ui(Module *m, int y, int x) {
    ...
    YELLOW();
    mvprintw(y + 1, x,
             "Real-time keys: -/= (mod freq), _/+ (car_amp), {/} (mod_amp), "
             "[/] (idx)");
    mvprintw(
        y + 2, x,
        "Command mode: :1 [mod freq], :2 [car amp], :3 [mod_amp], :4 [idx]");
    BLACK();
}
